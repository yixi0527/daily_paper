    ...
    payload.update(
        {
            ...
            "related_literature": article.related_literature,
            "related_literature_notes_zh": article.related_literature_notes_zh,
            "heuristic_thoughts_zh": article.heuristic_thoughts_zh,
